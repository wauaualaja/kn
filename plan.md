...
- [ ] **E-8 (sales · admin sales · finance — keputusan LENGKAP)** · [ ] **E-9 (rantai jual→beli internal→retur berantai)** · [ ] E-6- **Semua keputusan pemilik sudah terkumpul** (§0 + E7.7 + E8.10/E8.10b). Rencana ini
  **siap dieksekusi** tanpa pertanyaan tambahan, kecuali dua hal yang sengaja ditunda:
  (a) pemetaan 13 transaksi "Kas Besar Grup" ke entitas pemiliknya (butuh konfirmasi
  per baris saat migrasi), (b) daftar akun `manager` yang sebenarnya Admin Sales/Finance
  dan perlu diubah perannya.
- [ ] **Diparkir:** analisis akses & UI/UX **sales vs admin-sales** (dibahas setelah entitas beres).
