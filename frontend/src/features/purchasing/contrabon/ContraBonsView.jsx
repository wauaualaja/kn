      ...
      {summary && (
        <div className="mb-4 grid grid-cols-2 gap-3 md:grid-cols-3 xl:grid-cols-6"
          ...
          <div className="stat-card">
            ...
            <p className="text-[10px] text-[#8E8E93]">{formatCurrency(summary.scheduled_value)}</p>
          </div>
          <div className={`stat-card ${summary.due_soon_count ? "ring-1 ring-[#FFE0B2]" : ""}`}>
            ...
            <p className="text-[10px] text-[#8E8E93]">{formatCurrency(summary.due_soon_value)}</p>
          </div>
          <div className={`stat-card ${summary.disputed_count ? "ring-1 ring-[#F3C9C7]" : ""}`}>
            ...
            <p className="text-[10px] text-[#8E8E93]">{formatCurrency(summary.disputed_value)}</p>
          </div>
