      ...
      <div className="modal-card wide">
        ...
        <div className="mt-3 grid grid-cols-2 gap-3 md:grid-cols-4">
          <div className="stat-card">
            ...
            <p className="stat-value">{formatCurrency(t.bills_total)}</p>
          </div>
          <div className="stat-card">
            <p className="stat-label">Potongan</p>
            <p className="stat-value text-[#B26A00]">{formatCurrency(t.deductions_total)}</p>
          </div>
          <div className="stat-card">
            <p className="stat-label">Nilai bersih</p>
            <p className="stat-value text-[#0058CC]">{formatCurrency(t.net_payable)}</p>
          </div>
          <div className="stat-card">
